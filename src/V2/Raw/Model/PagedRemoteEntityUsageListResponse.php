<?php
/**
 * PagedRemoteEntityUsageListResponse
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * PagedRemoteEntityUsageListResponse Class Doc Comment
 *
 * @category Class
 * @package  EdgeBox\SyncCore\V2\Raw
 * @author   OpenAPI Generator team
 ...
 */
class PagedRemoteEntityUsageListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedRemoteEntityUsageListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\EdgeBox\SyncCore\V2\Raw\Model\RemoteEntityUsageEntity[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['numberOfPages'] === null) {
        ...
        if ($this->container['totalNumberOfItems'] === null) {
     ...
     * Sets items
     *
     * @param \EdgeBox\SyncCore\V2\Raw\Model\RemoteEntityUsageEntity[] $items items
     *
     * @return self
     */
