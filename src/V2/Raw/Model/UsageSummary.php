...
class UsageSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('contractMonthly', $data ?? [], null);
        $this->setIfExists('siteMonthly', $data ?? [], null);
        $this->setIfExists('siteHourly', $data ?? [], null);
    }
    ...
    {
        if (is_null($contractMonthly)) {
            throw new \InvalidArgumentException('non-nullable contractMonthly cannot be null');
        }
    ...
    {
        if (is_null($siteMonthly)) {
            throw new \InvalidArgumentException('non-nullable siteMonthly cannot be null');
        }
    ...
    {
        if (is_null($siteHourly)) {
            throw new \InvalidArgumentException('non-nullable siteHourly cannot be null');
        }
