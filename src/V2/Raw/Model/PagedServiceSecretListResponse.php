...
/**
 * PagedServiceSecretListResponse.
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PagedServiceSecretListResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PagedServiceSecretListResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedServiceSecretListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\EdgeBox\SyncCore\V2\Raw\Model\ServiceSecretEntity[]',
    ];
     ...
     * Sets items.
     *
     * @param ServiceSecretEntity[] $items items
     *
     * @return self
     */
