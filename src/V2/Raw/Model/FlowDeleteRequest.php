...
class FlowDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('keepFlowMachineNames', $data ?? [], null);
    }
    ...
    {
        if (is_null($keepFlowMachineNames)) {
            throw new \InvalidArgumentException('non-nullable keepFlowMachineNames cannot be null');
        }
