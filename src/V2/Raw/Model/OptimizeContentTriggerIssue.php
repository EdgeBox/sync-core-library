...
/**
 * OptimizeContentTriggerIssue Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class OptimizeContentTriggerIssue implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OptimizeContentTriggerIssue';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('typeKey', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['typeKey']) {
            $invalidProperties[] = "'typeKey' can't be null";
        }
    ...
    {
        return $this->container['typeKey'];
    }

    /**
     * Sets typeKey.
     *
     * @param string $typeKey typeKey
     *
     * @return self
     */
    ...
    {
        if (is_null($typeKey)) {
            throw new \InvalidArgumentException('non-nullable typeKey cannot be null');
        }
        $this->container['typeKey'] = $typeKey;
