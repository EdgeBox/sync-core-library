 ...
 * - This can mean that the credentials aren't valid, the site is blocking login requests or the REST interface doesn't
 *   allow the selected authentication type.
 */
