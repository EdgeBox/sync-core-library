...
/**
 * PagedContentRecommendationListResponse.
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PagedContentRecommendationListResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PagedContentRecommendationListResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedContentRecommendationListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\EdgeBox\SyncCore\V2\Raw\Model\ContentRecommendationEntity[]',
    ];
     ...
     * Sets items.
     *
     * @param ContentRecommendationEntity[] $items items
     *
     * @return self
     */
