...
class Terms implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * Sets assigned.
     *
     * @param null|TermAssignment[] $assigned assigned
     *
     * @return self
     */
     ...
     * Sets disallowed.
     *
     * @param null|TermAssignment[] $disallowed disallowed
     *
     * @return self
     */
    public function setDisallowed($disallowed)
    {
        if (is_null($disallowed)) {
            array_push($this->openAPINullablesSetToNull, 'disallowed');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('disallowed', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets summary.
     *
     * @param null|mixed $summary summary
     *
     * @return self
     */
