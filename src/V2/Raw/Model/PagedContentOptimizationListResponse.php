...
/**
 * PagedContentOptimizationListResponse.
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PagedContentOptimizationListResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PagedContentOptimizationListResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedContentOptimizationListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\EdgeBox\SyncCore\V2\Raw\Model\ContentOptimizationEntity[]',
    ];
     ...
     * Sets items.
     *
     * @param ContentOptimizationEntity[] $items items
     *
     * @return self
     */
