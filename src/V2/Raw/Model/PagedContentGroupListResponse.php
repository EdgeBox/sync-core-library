...
/**
 * PagedContentGroupListResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PagedContentGroupListResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedContentGroupListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\EdgeBox\SyncCore\V2\Raw\Model\ContentGroupEntity[]',
    ];
     ...
     * Sets items.
     *
     * @param ContentGroupEntity[] $items items
     *
     * @return self
     */
