...
/**
 * SiteLocaleDefinition Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SiteLocaleDefinition implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SiteLocaleDefinition';
    ...
    protected static $setters = [
        ...
        'localeDetection' => 'setLocaleDetection',
    ];
    ...
    protected static $getters = [
        ...
        'localeDetection' => 'getLocaleDetection',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('localeDetection', $data ?? [], null);
    }
    ...
    /**
     * Gets localeDetection.
     *
     * @return null|LocaleDetection
     */
    public function getLocaleDetection()
    {
        return $this->container['localeDetection'];
    }

    /**
     * Sets localeDetection.
     *
     * @param null|LocaleDetection $localeDetection localeDetection
     *
     * @return self
     */
    public function setLocaleDetection($localeDetection)
    {
        if (is_null($localeDetection)) {
            array_push($this->openAPINullablesSetToNull, 'localeDetection');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('localeDetection', $nullablesSetToNull);
            if (false !== $index) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['localeDetection'] = $localeDetection;
