...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://syndication.cms-content-sync.io';
    ...
    {
        $report = 'PHP SDK (EdgeBox\SyncCore\V2\Raw) Debug Report:'.PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                'url' => 'https://syndication.cms-content-sync.io',
