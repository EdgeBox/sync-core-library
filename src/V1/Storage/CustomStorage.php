...
{
    public const APPLICATION_DRUPAL = 'drupal';
     ...
     *             pool connection
     */
    public const POOL_DEPENDENCY_CONNECTION_ID = 'drupal-[api.name]-'.InstanceStorage::POOL_SITE_ID.'-[entity_type.name_space]-[entity_type.name]';
     ...
     */
    public const DEPENDENCY_CONNECTION_ID = 'drupal-[api.name]-[instance.id]-[entity_type.name_space]-[entity_type.name]';
