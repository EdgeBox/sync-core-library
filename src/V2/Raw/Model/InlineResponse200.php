...
class InlineResponse200 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets info
     *
     * @param map[string,map[string,string]]|null $info info
     *
     * @return self
     */
     ...
     * Sets error
     *
     * @param map[string,map[string,string]]|null $error error
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param map[string,map[string,string]]|null $details details
     *
     * @return self
     */
