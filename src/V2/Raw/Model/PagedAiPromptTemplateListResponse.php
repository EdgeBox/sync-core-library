...
/**
 * PagedAiPromptTemplateListResponse.
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PagedAiPromptTemplateListResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PagedAiPromptTemplateListResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedAiPromptTemplateListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\EdgeBox\SyncCore\V2\Raw\Model\AiPromptTemplateEntity[]',
    ];
     ...
     * Sets items.
     *
     * @param AiPromptTemplateEntity[] $items items
     *
     * @return self
     */
