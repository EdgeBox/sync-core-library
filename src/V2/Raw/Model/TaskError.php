 ...
 */
class TaskError implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TaskError';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('requestDetails', $data ?? [], null);
