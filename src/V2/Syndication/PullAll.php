...
class PullAll extends SerializableWithSyncCoreReference implements IPullAll {
   ...
   *
   * @param SyncCore $core
   * @param string $namespaceMachineName
  ...
  public function hasFinished() {
    return $this->getDto()->getStatus()===SyndicationStatus::_400_FINISHED;
  }
  public function hasFailed() {
    return $this->getDto()->getStatus()===SyndicationStatus::_500_FAILED;
  }
  public function wasAborted() {
    return $this->getDto()->getStatus()===SyndicationStatus::_600_ABORTED;
  }
