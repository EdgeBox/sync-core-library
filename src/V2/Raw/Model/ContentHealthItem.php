...
/**
 * ContentHealthItem Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ContentHealthItem implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ContentHealthItem';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['itemKey']) {
     ...
     * Sets state.
     *
     * @param HealthItemState $state state
     *
     * @return self
     */
