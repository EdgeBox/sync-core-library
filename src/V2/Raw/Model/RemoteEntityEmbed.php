...
class RemoteEntityEmbed implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param object|null $referenceDetails referenceDetails
     *
     * @return self
     */
