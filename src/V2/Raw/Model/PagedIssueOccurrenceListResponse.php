...
/**
 * PagedIssueOccurrenceListResponse.
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PagedIssueOccurrenceListResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class PagedIssueOccurrenceListResponse implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedIssueOccurrenceListResponse';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\EdgeBox\SyncCore\V2\Raw\Model\IssueOccurrenceEntity[]',
    ];
     ...
     * Sets items.
     *
     * @param IssueOccurrenceEntity[] $items items
     *
     * @return self
     */
