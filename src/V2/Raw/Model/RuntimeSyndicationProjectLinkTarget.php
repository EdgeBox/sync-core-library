<?php
/**
 * RuntimeSyndicationProjectLinkTarget.
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RuntimeSyndicationProjectLinkTarget Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class RuntimeSyndicationProjectLinkTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RuntimeSyndicationProjectLinkTarget';
    ...
    protected static $openAPITypes = [
        ...
        'projectLink' => '\EdgeBox\SyncCore\V2\Raw\Model\RuntimeRemoteEntityDependencyWithDependenciesEntity',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('projectLink', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['projectLink']) {
            $invalidProperties[] = "'projectLink' can't be null";
        }
    ...
    {
        return $this->container['projectLink'];
    }

    /**
     * Sets projectLink.
     *
     * @param \EdgeBox\SyncCore\V2\Raw\Model\RuntimeRemoteEntityDependencyWithDependenciesEntity $projectLink projectLink
     *
     * @return self
     */
    public function setProjectLink($projectLink)
    {
        if (is_null($projectLink)) {
            throw new \InvalidArgumentException('non-nullable projectLink cannot be null');
        }
        $this->container['projectLink'] = $projectLink;
