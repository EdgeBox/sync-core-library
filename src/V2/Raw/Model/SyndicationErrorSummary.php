...
/**
 * SyndicationErrorSummary Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
...
class SyndicationErrorSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SyndicationErrorSummary';
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['syndication']) {
            $invalidProperties[] = "'syndication' can't be null";
        }
        if (null === $this->container['status']) {
            $invalidProperties[] = "'status' can't be null";
        }
        if (null === $this->container['operationErrors']) {
            $invalidProperties[] = "'operationErrors' can't be null";
        }
    ...
    public function setOperationErrors($operationErrors)
    {
        if (is_null($operationErrors)) {
            throw new \InvalidArgumentException('non-nullable operationErrors cannot be null');
        }
