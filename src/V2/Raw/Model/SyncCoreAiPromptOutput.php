...
/**
 * SyncCoreAiPromptOutput Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SyncCoreAiPromptOutput implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SyncCoreAiPromptOutput';
    ...
    public function setTextFormat($textFormat)
    {
        if (is_null($textFormat)) {
            array_push($this->openAPINullablesSetToNull, 'textFormat');
        } else {
